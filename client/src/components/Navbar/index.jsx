    ...
    <div className={classes.headerWrapper} data-testid="navbar">
      <div className={classes.contentWrapper}>
        <div className={classes.logoImage} onClick={goHome}>
          <img src="https://www.vespa.com/dam/jcr:8d3798ca-a10a-4d85-839e-1bd03f0ff9ac/grey-titanio-02.png" alt="logo" className={classes.logo} />
          <div className={classes.title}>TransPINJEM</div>
        </div>
